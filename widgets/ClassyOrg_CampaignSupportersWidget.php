...
class ClassyOrg_CampaignSupportersWidget extends WP_Widget
{
    const ID = 'ClassyOrg_CampaignSupportersWidget';
    ...
    {
        parent::__construct(self::ID, 'Classy.org: Campaign Supporters');
    }
